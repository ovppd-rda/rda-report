...
- The vast majority of units (94%, n=58) have current and valid leases, showing that lease renewal requirements are generally well‑observed.

- A small portion (5%, n=3) have expired leases but are already in the process of renewal.

- Only 2% (n=1) of units have expired leases with no renewal, highlighting very limited non‑compliance.
...
```{r}
## subtitle text
subtitle_text <- str_wrap("Most units comply with residential use rules: 94% are used strictly for family, 95% report no boarders, and 100% have never sub‑leased. Only a few cases show minor exceptions.", 70)
...
```{r}
## subtitle text
subtitle_text <- str_wrap("Most units are consistently compliant with noise regulations, with 92% (n=57) reporting no disturbances. Only 5% (n=3) occasionally and 3% (n=2) frequently experience issues", 70)
...
- Over half of respondents (52%, n=32) reported no repair requests in the past year,

- About one‑third (35%, n=22) requested repairs 1–2 times and Only 8% (n=5) reported 3–5 repair requests, and 5% (n=3) reported more than 5.

```{r}
title_plot <- glue("Frequency of repairs requested (n = {nrow(housing_dta)})")
subtitle_text <- str_wrap("Over half of respondents (52%, n=32) reported no repair requests in the past year, while 35% (n=22) requested repairs 1–2 times. Only a small share experienced more frequent issues, with 8% (n=5) requesting 3–5 times and 5% (n=3) more than 5 times.", 80)
...
subtitle_text <- str_wrap("subtitle text", 80)
...
subtitle_text <- str_wrap("subtitle text", 70)
