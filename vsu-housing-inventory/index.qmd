...
```{r}
## subtitle
subtitle_text <- str_wrap("The majority of units (94%, n=58) have current and valid leases, while a small proportion are either in the process of renewal (5%, n=3) or have expired without renewal (2%, n=1).", 80)
...
p_lease_renewal <- 
    ...
    labs(
        title = glue("Status of lease renewal (n = {nrow(housing_dta)})"),
        subtitle = subtitle_text,
>>>>>>> a213d707e21a9ff2ef5cdcc59d88b0e0c5df6ae9
        x = NULL,
        y = NULL
    ) +
    custom_theme()
